...
export default function LandingPage({
      ...
      <div className="landing-page__inner">
        ...
        <div className="landing-card-grid">
          ...
          >
            ...
            <p>
              Start from the main exploration page with key concepts,
              hierarchical and chapter-aware summaries.
            </p>
          </button>
          ...
          >
            ...
            <p>
              Explore shared concepts, unique topics, visible domains, and the
              recommended learning path across the dataset.
            </p>
          </button>
          ...
          >
            ...
            <h3>Network View</h3>
            <p>
              Discover how videos connect through shared concepts and navigate
              the strongest conceptual overlaps interactively.
            </p>
         </button>
         </div>
  ...
  <div className="landing-capabilities-grid">
    <article className="landing-capability">
      ...
      <p>
        State-of-the-art video segmentation using large language models with
        multimodal inputs such as transcripts and frame captions.
      </p>
    </article>
    ...
    <article className="landing-capability">
      ...
      <p>
        Generate summaries at multiple levels, including short, medium, long,
        chapter-level, and collection-wide insights.
      </p>
    </article>
    ...
    <article className="landing-capability">
      ...
      <p>
        Interactive timelines, network graphs, comparison views, and topic
        visualizations support deeper exploration across videos and collections.
      </p>
    </article>
  </div>
</section>
